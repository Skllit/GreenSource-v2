    ...
    <div className="p-4 sm:p-6 md:p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">View your delivery history and performance</p>
        </div>
        <div className="flex items-center space-x-2">
          <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-lg px-4 py-2 border border-gray-200 dark:border-gray-700">
            <span className="text-sm text-gray-600 dark:text-gray-400">Total Completed:</span>
      ...
      {deliveries.length === 0 ? (
        <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 text-center border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No Completed Deliveries</h3>
          <p className="text-gray-600 dark:text-gray-400">You haven't completed any deliveries yet.</p>
        </div>
      ) : (
