  ...
  if (user && user.userType === "consumer") {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col items-center justify-center">
        ...
        <h1 className="text-lg text-gray-600 dark:text-gray-300">Redirecting to consumer profile page...</h1>
      </div>
    );
  }
      ...
      >
        <div className="flex flex-col h-full">
          <div className="hidden md:block p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Farmer Dashboard</p>
          </div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="hidden md:block text-left">
                    <p className="font-medium text-gray-800 dark:text-white">{user?.username || "Farmer"}</p>
